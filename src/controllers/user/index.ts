...
export const signIn = (req: ApiRequest<{}, UserSignInResponseBody, UserSignInRequestBody>, res: ApiResponse): void => {
...
export const whoami = (req: ApiRequest<{}, UserSignInResponseBody, UserSignInRequestBody>, res: ApiResponse): void => {
